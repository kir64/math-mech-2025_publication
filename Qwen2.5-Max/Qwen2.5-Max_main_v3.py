...
def test_update_pet_with_form():
    ...
    make_request("POST", f"/pet/{pet_id}", 400, data=data)  # Корректный статус-код
...
@pytest.mark.pet
def test_invalid_status_for_find_by_status():
    """GET /pet/findByStatus: Негативный тест с невалидным статусом"""
...
def test_invalid_tags_for_find_by_tags():
    ...
    make_request("GET", "/pet/findByTags", 200, params=params)  # API возвращает 200 вместо 400
